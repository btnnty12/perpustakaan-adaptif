...
<script>
    ...
    // Mapping path ke route
    const pathToRoute = {
        '/staff': 'staff.dashboard',
        '/staff/kelola-buku': 'staff.kelola-buku',
        '/staff/laporan-peminjaman': 'staff.laporan-peminjaman',
        '/staff/data-anggota': 'staff.data-anggota',
        'staff/pengaturan': 'staff.pengaturan'
    };
